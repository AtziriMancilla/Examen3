...
public class Menu {
    ...
    public static void pruebasAcueducto(){
        ...
        Gerente gerenteunico = new Gerente("Alejandro", "Montejano", "Diaz","Morelia", "Michoacan", "MODA736354", "Xangari", 2003, LocalDate.now(),"MODA736354", "Mario", "DrProfesor", 20000, "contraseñaSecreta" );
